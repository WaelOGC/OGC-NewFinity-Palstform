...
function SocialLogin() {
  ...
  const providers = [
    { name: 'Google', icon: GoogleIcon, handler: () => handleSocialLogin('Google') },
    { name: 'X', icon: XIcon, handler: () => handleSocialLogin('X') },
    { name: 'LinkedIn', icon: LinkedInIcon, handler: () => handleSocialLogin('LinkedIn') },
    { name: 'Discord', icon: DiscordIcon, handler: () => handleSocialLogin('Discord') },
    { name: 'GitHub', icon: GitHubIcon, handler: () => handleSocialLogin('GitHub') },
  ];

  return (
    <div className="social-login">
      <div className="social-login__divider">
        <span className="social-login__divider-text">Or continue with</span>
      </div>
      <div className="social-login__buttons">
        {providers.map((provider) => {
          ...
          return (
            ...
            >
              <Icon className="social-login__icon" />
              <span className="social-login__label">{provider.name}</span>
            </button>
          );
        })}
      </div>
      ...
      <p className="social-login__terms-note">
        ...
        and{" "}
        <a href="/legal/privacy" target="_blank" rel="noopener noreferrer" className="social-login__terms-link">
          Privacy Policy
        </a>
        .
      </p>
